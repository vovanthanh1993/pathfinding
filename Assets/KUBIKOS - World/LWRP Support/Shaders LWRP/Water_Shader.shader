    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 triplanar2 = TriplanarSamplingSF( _TopTexture0, WorldSpacePosition, WorldSpaceNormal, 0.5, 0.5, 1.0, 0 );
				float2 temp_cast_0 = (( _Time.x + 10.0 )).xx;
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN  ) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 triplanar2 = TriplanarSamplingSF( _TopTexture0, ase_worldPos, ase_worldNormal, 0.5, 0.5, 1.0, 0 );
           		float2 temp_cast_0 = (( _Time.x + 10.0 )).xx;
           		float2 uv043 = IN.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_0;
           		float2 panner42 = ( 1.0 * _Time.y * float2( 0,0 ) + uv043);
           		float2 uv_Cubes = IN.ase_texcoord2.xy * _Cubes_ST.xy + _Cubes_ST.zw;
...
/*ASEBEGIN
Version=16800
35;1;1787;1010;973.4637;990.1058;1.561095;True;True
...
Node;AmplifyShaderEditor.SamplerNode;41;-150.5813,-247.5406;Float;True;Property;_TextureSample6;Texture Sample 6;1;0;Create;True;0;0;False;0;None;8e2d46f8740829c41ba5c938af7a77b3;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;75;-128.9959,20.32384;Float;True;Property;_Cubes;Cubes;2;0;Create;True;0;0;False;0;None;464ac292797d7d64a815c4064562d285;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=76FA00403BB8F1931CBDD16CD86A5A204A371C9A