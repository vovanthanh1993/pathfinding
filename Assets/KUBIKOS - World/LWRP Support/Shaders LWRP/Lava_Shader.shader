    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 triplanar2 = TriplanarSamplingSF( _TopTexture0, WorldSpacePosition, WorldSpaceNormal, 1.0, 2.0, 1.0, 0 );
				float2 temp_cast_1 = (( _Time.x + 10.0 )).xx;
				...
				float3 Emission = ( ( ( CalculateContrast(_Float0,( triplanar2 * ( _Contrast * ( _SinTime.w + 3.0 ) ) )) * tex2D( _TextureSample6, panner42 ) ) * ( _Intensity * ( _SinTime.w + 3.0 ) ) ) + tex2D( _Cubes, uv_Cubes ) ).rgb;
        ...
        Pass
        {
            ...
            half4 frag(VertexOutput IN  ) : SV_TARGET
            {
                UNITY_SETUP_INSTANCE_ID(IN);
           		...
           		float4 triplanar2 = TriplanarSamplingSF( _TopTexture0, ase_worldPos, ase_worldNormal, 1.0, 2.0, 1.0, 0 );
           		float2 temp_cast_1 = (( _Time.x + 10.0 )).xx;
           		float2 uv043 = IN.ase_texcoord2.xy * float2( 1,1 ) + temp_cast_1;
           		float2 panner42 = ( 1.0 * _Time.y * float2( 0,0 ) + uv043);
...
/*ASEBEGIN
Version=16800
35;7;1787;1004;2478.626;2187.804;3.220883;True;True
...
ASEEND*/
//CHKSM=21A47BB9C1BAE76E63E71EB06A5EAC014974EC3A