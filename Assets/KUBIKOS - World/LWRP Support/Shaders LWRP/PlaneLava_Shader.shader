    ...
    SubShader
    {
        ...
        Pass
        {
        	...
        	half4 frag (GraphVertexOutput IN  ) : SV_Target
            {
				...
				float4 temp_output_49_0 = ( ( CalculateContrast(_Float0,( triplanar2 * ( _Contrast * ( _SinTime.w + 3.0 ) ) )) * tex2D( _TextureSample6, panner42 ) ) * ( _Intensity * ( _SinTime.w + 3.0 ) ) );
...
/*ASEBEGIN
Version=16800
35;7;1787;1004;538.337;1152.604;1.494653;True;True
...
ASEEND*/
//CHKSM=82A240F5FEA65E5A8C9790D7432BED1115AECC76